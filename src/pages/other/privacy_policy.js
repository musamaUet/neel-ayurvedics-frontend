...
const Privacy_policy = () => {
  return (
    <LayoutSix>
      {/* breadcrumb */}
      <BreadcrumbOne pageTitle="Privacy Policy">
      ...
      <div className="terms-content space-pt--r100 space-pb--r100">
        <Container>
          <Row>
			...
			<p>NEEL AYURVEDICS operates the <a href="https://www.neelayurvedics.com/">https://www.neelayurvedics.com/</a> website, which provides the SERVICEs of purchasing Ayurveda products.</p>
...
<ol>
<li>E-mail id – <a href="mailto:contact@neelayurvedics.com">contact@neelayurvedics.com</a></li>
<li>Postal Address – “Neel Ayurvedics”, Millpara main road, Rajkot-360002, Gujarat.</li>
</ol>
