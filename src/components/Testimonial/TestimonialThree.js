...
const TestimonialThree = ({title, testimonialDataThree }) => {
  ...
  return (
    <div className="testimonial-area back2 space-pb--50 hide1">
     <div className="custom-container">
      <Row>
        ...
        <div className="product-slider-wrap newbox4 product-slider-wrap--custom-bullet">
              <Swiper {...params} getSwiper={setSwiper}>
                {testimonialDataThree &&
                  testimonialDataThree.map((single, key) => {
                    return (
